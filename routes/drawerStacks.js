...
import { HomeTitle, ProfileTitle, ShoppingTitle, CalendarTitle, NotificationTitle, StockInfoTitle, SearchTitle, ComplianceTitle, TermsTitle, TechTitle, SubcriptionTitle, BankingTitle, PeersTitle } from './headerTitles'
...
const DashboardStackScreen = ({ navigation }) => {
    ...
    return (
        <DashBoardStack.Navigator
            ...
            <DashBoardStack.Screen name="home" component={Home} options={{
...
const CulinaryStackScreen = ({ navigation }) => {
    ...
    return (
        <CulinaryStack.Navigator
            initialRouteName="home" >
            <CulinaryStack.Screen name="culinaryhome" component={CulinaryHome} options={{
            ...
            />
            <CulinaryStack.Screen name="dailyMenu" component={DailyMenu} options={{
                headerTitle: props => <ProfileTitle {...props} />,
                headerTitleStyle: {
                    alignSelf: 'center',
                    color: '#ffffff',
            ...
            />
            <CulinaryStack.Screen name="placeOrder" component={PlaceOrder} options={{
                headerTitle: props => <ProfileTitle {...props} />,
                headerTitleStyle: {
                    alignSelf: 'center',
                    color: '#ffffff',
            ...
            />
            <CulinaryStack.Screen name="alaCarte" component={AlaCarte} options={{
                headerTitle: props => <ProfileTitle {...props} />,
                headerTitleStyle: {
                    alignSelf: 'center',
                    color: '#ffffff',
            ...
            <CulinaryStack.Screen name="orderHistory" component={OrderHistory} options={{
                headerTitle: props => <ProfileTitle {...props} />,
                headerTitleStyle: {
                    alignSelf: 'center',
                    color: '#ffffff',
...
const ShoppingStackScreen = ({ navigation }) => {
    ...
    return (
        <ShoppingStack.Navigator
            initialRouteName="home" >
            <ShoppingStack.Screen name="home" component={ShoppingHome} options={{
...
const CalendarStackScreen = ({ navigation }) => {
    ...
    return (
        <CalendarStack.Navigator
            initialRouteName="home" >
            <CalendarStack.Screen name="home" component={CalendarHome} options={{
            ...
            />
            <CalendarStack.Screen name="details" component={EventDetails} options={{
                headerTitle: props => <CalendarTitle {...props} />,
                headerTitleStyle: {
                    alignSelf: 'center',
                    color: '#ffffff',
            ...
            />
            <CalendarStack.Screen name="enroll" component={EnrollEvent} options={{
                headerTitle: props => <CalendarTitle {...props} />,
                headerTitleStyle: {
                    alignSelf: 'center',
                    color: '#ffffff',
...
export { DashboardStackScreen, CulinaryStackScreen, ShoppingStackScreen, CalendarStackScreen }
