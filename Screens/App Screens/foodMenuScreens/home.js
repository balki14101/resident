                        ...
                        <View style={{ alignItems: 'center', width: '100%',height:'100%' }}>
                            ...
                            <View style={{ width: '100%', paddingHorizontal: 10, marginTop: '6%' }}>
                                <TouchableOpacity onPress={()=>navigation.navigate('dailyMenu')} style={styles.welcomeContainer}>
                                    <ImageBackground source={{ uri: 'https://dukeofyorksquare.com/wp-content/uploads/2017/02/Pancakes-2.jpg' }} style={{ height: 120, borderRadius: 10, overflow: 'hidden' }} >
                                ...
                                <TouchableOpacity onPress={()=>navigation.navigate('alaCarte')} style={styles.welcomeContainer}>
                                    <ImageBackground source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4-8dTbiLNTKc-gfdRRUpW0QTSQ5VN_eBjocMy3XswZt2LMeQKQe6VJtTvAp5K0Ewg-tY&usqp=CAU' }} style={{ height: 120, borderRadius: 10, overflow: 'hidden' }} >
                                        <View style={{ height: '100%', width: '100%', backgroundColor: 'rgba(0,0,0,.3)', borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
                                ...
                                <TouchableOpacity onPress={()=>navigation.navigate('orderHistory')} style={styles.welcomeContainer}>
                                    <ImageBackground source={{ uri: 'https://i2.wp.com/theverybesttop10.com/wp-content/uploads/2015/05/Top-10-Crazy-and-Unusual-Square-Foods-7-510x541.jpg?resize=600%2C636' }} style={{ height: 120, borderRadius: 10, overflow: 'hidden' }} >
                                        <View style={{ height: '100%', width: '100%', backgroundColor: 'rgba(0,0,0,.3)', borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
