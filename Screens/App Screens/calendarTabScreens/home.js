          ...
          <ScrollView style={{width: '100%', height: '100%'}}>
            ...
            <View
              ...
              <Text
                style={[
                  styles.helloTxt,
                  {fontSize: 18, fontFamily: 'proxima-nova-light'},
                ]}>
                The day is
                <Text
                  style={{fontSize: 24, fontFamily: 'proxima-nova-semiBold'}}>
                  {' '}
                  Thursday
                </Text>
              </Text>
              ...
              <View style={styles.upcomingConatiner}>
                ...
                <View style={styles.eventBox}>
                  <Icon
                    name="list-alt"
                    size={30}
                    style={{color: '#616D2F'}}></Icon>
                  <View
                    style={{
                      paddingLeft: 10,
                      marginLeft: 10,
                      borderLeftColor: '#616D2F',
                      borderLeftWidth: 1,
                    }}>
                ...
                <View style={styles.eventBox}>
                  <FontAwesome5Icon
                    name="handshake-o"
                    size={24}
                    style={{color: '#616D2F', marginTop: 3}}></FontAwesome5Icon>
                  <View
                    style={{
                      paddingLeft: 10,
                      marginLeft: 10,
