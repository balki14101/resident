                        ...
                        changeCompliant ? <BluredSection /> :
                            <View style={{flex:1}}>
                             ...
                             {!isLoading && stocks.length>0 &&
                                <TouchableOpacity style={{backgroundColor:'white', height:200, borderRadius:10}}
                                onPress={() => navigation.navigate('single', {stock:stocks[0]})}>

                                    <Text style={styles.imageTextBig}>{stocks[0].stockName}</Text>
                                    <View style={{paddingLeft:10}} >

                                        <HTML 
                                            source={{ html:decode(stocks[0].description.substr(0,490)+'...') }}
                                        />                       
                      
                                    </View>
                                    <View style={{ flexDirection: 'row', display:'none', marginTop: 29, paddingLeft: '55%', marginBottom: 16 }}>
                                        <Text style={{ color: '#3397F8', paddingRight: 7, fontSize: 15, fontFamily: 'poppins_semiBold' }}>Tap to Explore</Text>
                                        <Arrow name="arrowright" size={20} color="#3397F8" style={{ top: 2 }} />
                                    </View>
                                ...
                                <View style={{ marginBottom: 50 }}>
                                    ...
                                    <CompanyList navigation={props.navigation} stocks={stocks.slice(1)} sectorName="Advisory"/>
